...
class DataGenerator:
    def create_sin(self, n= None, fs= None, f= None):
        # Funkcja na początku działała na losowych danych, funkcjonalność ta została zachowana i jest użyta, gdy użytkownik nie
        # zdefiniuje własnych danych
        if (n == None or fs == None or f == None): 
